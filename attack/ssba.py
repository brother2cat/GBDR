...
from utils.bd_transform_generate import bd_attack_label_trans_generate, ssba_img_trans_generate
...
class SSBA(standard_framework):
    def __init__(self, yaml_path):
        super(SSBA, self).__init__()
        ...
        with open(self.yaml_path, 'r') as f:
            ...
            self.path_replace_image = bd_defaults['path_replace_image']
    ...
    def bd_dataset_prepare(self):
        ...
        self.bd_train_image_change, \
            ...
            ssba_img_trans_generate(self.attack, self.path_replace_image, self.args.image_size, self.args.dataset)
...
if __name__ == '__main__':
    ssba = SSBA("config/attack/ssba/bd_cifar10_WRN28.yaml")
    ssba.bd_dataset_prepare()
    ssba.train()
