...
from utils.bd_transform_generate import badnet_img_trans_generate, bd_attack_label_trans_generate
...
class BadNet(standard_framework):
    ...
    def bd_dataset_prepare(self):
        ...
        self.bd_train_image_change, \
            ...
            badnet_img_trans_generate(self.attack, self.patch_mask_path, self.args.image_size, self.args.dataset)
...
if __name__ == '__main__':
    badnet = BadNet("config/attack/badnet/bd_cifar10_WRN28.yaml")
    badnet.bd_dataset_prepare()
    badnet.train()
