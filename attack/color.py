...
from utils.bd_transform_generate import color_img_trans_generate, bd_attack_label_trans_generate
...
class Color(standard_framework):
    def __init__(self, yaml_path):
        ...
        with open(self.yaml_path, 'r') as f:
            ...
            self.color_shift = bd_defaults['color_shift']
    ...
    def bd_dataset_prepare(self):
        ...
        self.bd_train_image_change, \
            ...
            color_img_trans_generate(self.attack, self.color_shift, self.args.image_size, self.args.dataset)
...
if __name__ == '__main__':
    color = Color("config/attack/color/bd_cifar10_WRN28.yaml")
    color.bd_dataset_prepare()
    color.train()
