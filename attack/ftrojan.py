...
from utils.bd_transform_generate import ftrojan_img_trans_generate, bd_attack_label_trans_generate
...
class Ftrojan(standard_framework):
    def __init__(self, yaml_path):
        ...
        with open(self.yaml_path, 'r') as f:
            ...
            self.channel_list = bd_defaults['channel_list']
            self.magnitude = bd_defaults['magnitude']
            self.YUV = bd_defaults['YUV']
            self.window_size = bd_defaults['window_size']
            self.pos_list = bd_defaults['pos_list']
    ...
    def bd_dataset_prepare(self):
        ...
        self.bd_train_image_change, \
            ...
            ftrojan_img_trans_generate(self.attack, self.args.image_size,
                                       self.channel_list, self.magnitude, self.YUV, self.window_size, self.pos_list)
...
if __name__ == '__main__':
    attack = Ftrojan("config/attack/ftrojan/bd_cifar10_WRN28.yaml")
    attack.bd_dataset_prepare()
    attack.train()
