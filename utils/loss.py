...
class SimCLRLoss(nn.Module):
    ...
    def forward(self, features):
        """
        :param features: hidden feature representation of shape [b, 2, dim]
        :return: loss computed according to SimCLR
        """
...
class SCELoss(nn.Module):
    ...
    def __init__(self, alpha=0.5, beta=0.5, num_classes=10, reduction="mean"):
